...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Formulario de creación de moto</h2>
      <!--
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="username" class="form-label">Cilindrada</label>
            ...
            <div class="col-12">
              <label for="email" class="form-label">Estilo<span class="text-body-secondary">(Optional)</span></label>
            ...
            <div class="col-12">
              <label for="address" class="form-label">Anio</label>
